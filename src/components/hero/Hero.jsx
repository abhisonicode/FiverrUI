...
const Hero = () => {
  return (
    <>
      <div
        id="hero"
        className="flex flex-row items-center px-6 md:px-16 bg-green-900 h-[100vh] -mt-16"
      >
        {/* ---------------------------------
            Left Section
        --------------------------------- */}
        <div className="basis-1/2 flex flex-col gap-y-7">
          <h1 className="text-white font-bold text-6xl">
            Find the right <span className="font-normal italic">freelance</span>{" "}
            service, right away
          </h1>
          <div>
            <label
        ...
        <div className="basis-1/2 flex flex-col gap-y-5 h-full justify-end ">
          <img
            className=" "
            src={"https://i.ibb.co/XY2ZwF1/Screenshot-39-removebg-preview.png"}
          />
        </div>
      </div>
    </>
