            ...
            <div className="w-full px-5 flex flex-col justify-between">
              <div className="flex flex-col mt-5">
                <div className="flex justify-end mb-4">
                  <div className="mr-2 py-3 px-4 bg-green-500 rounded-bl-3xl rounded-tl-3xl rounded-tr-xl text-white">
                ...
                <div className="flex justify-end mb-4">
                  <div>
                    ...
                    <div className="mt-4 mr-2 py-3 px-4 bg-green-500 rounded-bl-3xl rounded-tl-3xl rounded-tr-xl text-white">
                      Lorem ipsum dolor sit amet consectetur adipisicing elit.
                      Debitis, reiciendis!
                    </div>
                  </div>
              ...
              <div className="py-5">
                <div className="relative">
                  <textarea
                    ...
                    required=""
                  />
                  <button className="text-white absolute right-2.5 bottom-2.5 bg-green-500  focus:outline-none  font-medium rounded-lg text-sm px-4 py-2 ">
                    Send
                  </button>
                </div>
              </div>
